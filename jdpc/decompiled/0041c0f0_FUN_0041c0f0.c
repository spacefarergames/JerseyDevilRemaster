...

{
  ...
  do {
    ...
    puVar8 = &DAT_00561900 + iVar4 * 0x10;
    DAT_0055fd88 = iVar4;
    do {
      iVar4 = puVar8[3] - puVar8[2];
      if (iVar4 != 0 && (int)puVar8[2] <= (int)puVar8[3]) {
        ...
        do {
          iVar4 = DAT_0055eb40;
          uVar2 = (uint)bVar11;
          uVar5 = DAT_0055fda4 >> 0xc;
          uVar1 = *puVar9;
          DAT_0055fda4 = DAT_0055fdac + DAT_0055fda4;
          *(undefined1 *)puVar10 =
               *(undefined1 *)
                (DAT_0055fdb0 + (*(uint *)((int)puVar10 + -1) & 0xff00) +
                (*(uint *)(&DAT_0045f818 + (uVar5 & 0xfc0) + (uVar1 >> 2 & 0x3f)) & 0xff));
          iVar3 = DAT_0055fdb0;
          uVar7 = DAT_0055fd8c >> 0xc;
          uVar6 = DAT_0055eb4c + DAT_0055fda8;
          uVar5 = DAT_0055fda8 >> 0xc;
          DAT_0055fd8c = iVar4 + DAT_0055fd8c;
          *(undefined1 *)((int)puVar10 + 1) =
               *(undefined1 *)
                ((*(uint *)(&DAT_0045f818 + (uVar1 >> 10 & 0x3f) + (uVar7 & 0xfc0)) & 0xff) +
                DAT_0055fdb0 + (*puVar10 & 0xff00));
          DAT_0055fda8 = uVar6;
          *(undefined1 *)((int)puVar10 + 2) =
               *(undefined1 *)
                (iVar3 + (*(uint *)((int)puVar10 + 2) & 0xff) * 0x100 +
                (*(uint *)(&DAT_0045f818 + (uVar5 & 0xfc0) + (uVar1 >> 0x12 & 0x3f)) & 0xff));
          ...
          puVar9 = (uint *)((int)puVar9 + (*(int *)(&DAT_0055e1c4 + uVar2 * -4) + (uint)bVar12) * 3)
          ;
          iVar4 = DAT_0055ed60 + -1;
