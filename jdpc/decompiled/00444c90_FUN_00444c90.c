/*
 * Function: FUN_00444c90
 * Entry:    00444c90
 * Warning:  Decompiled pseudocode, not original source.
 */


uint FUN_00444c90(undefined4 *param_1,uint param_2,uint param_3,int *param_4)
    ...
    if (((piVar1[3] & 0x10cU) == 0) || (uVar2 = piVar1[1], uVar2 == 0)) {
      if (uVar7 < uVar5) {
        ...
        *(char *)param_1 = (char)iVar4;
        ...
        iVar3 = FUN_004440f0(piVar1[4],param_1,uVar2);
        if (iVar3 == 0) {
