/*
 * Function: FUN_0042eb80
 * Entry:    0042eb80
 * Warning:  Decompiled pseudocode, not original source.
 */


int FUN_0042eb80(short *param_1,uint param_2,int param_3)

{
  ...
  do {
    if ((((param_2 & *(uint *)(iVar5 + 8)) != 0) && (*(short *)(iVar5 + 0x24) == 2)) &&
      ...
      *psVar1 = *param_1;
      *(short *)(param_3 + 0x42) = param_1[2];
      *(short *)(param_3 + 0x44) = param_1[4];
      ...
      *(undefined2 *)(param_3 + 0x20) = 0x1000;
      ...
      if ((((*(short *)(iVar5 + 0x30) - iVar4 <= (int)*(short *)(param_3 + 0x38)) &&
         ...
         (*(short *)(param_3 + 0x3a) <= *(short *)(iVar5 + 0x32))) {
        return iVar5;
      }
    }
