...
void FUN_0044bdb0(byte *param_1,undefined4 *param_2,byte *param_3,int *param_4,int *param_5)
    ...
    *param_5 = *param_5 + 1;
    ...
    do {
      *piVar6 = *piVar6 + 1;
      ...
      if ((*(byte *)((int)&DAT_004a64c0 + (int)param_5 + 1U) & 4) != 0) {
        *piVar6 = *piVar6 + 1;
        if (param_3 != (byte *)0x0) {
          *param_3 = *pbVar7;
          param_3 = param_3 + 1;
