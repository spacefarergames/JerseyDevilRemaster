...

{
  ...
  while (iVar2 != 0) {
    ...
    if (((((0.0 < pfVar7[2]) &&
        ...
        (0.0 < *(float *)((uint)*(ushort *)(iVar2 + param_1[3] * 2) * 0x10 + 8 + iVar6))) ||
