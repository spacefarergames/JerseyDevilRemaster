/*
 * Function: FUN_0044cb60
 * Entry:    0044cb60
 * Warning:  Decompiled pseudocode, not original source.
 */


undefined4 FUN_0044cb60(int param_1,int param_2)

{
  ...
  if (((*(uint *)(param_1 + iVar3 * 4) & 1 << (bVar2 & 0x1f)) != 0) &&
     (iVar1 = FUN_0044ca80(param_1,param_2 + 1), iVar1 == 0)) {
    local_4 = FUN_0044caf0(param_1,param_2 + -1);
  }
