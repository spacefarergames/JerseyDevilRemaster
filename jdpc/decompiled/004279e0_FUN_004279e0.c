...
uint FUN_004279e0(int param_1,int param_2,int param_3,int param_4)

{
  ...
  do {
    ...
    uVar10 = __ftol();
    fVar13 = ((float10)local_18 - (float10)-1.4) *
             (float10)(int)((uVar10 ^ (int)uVar10 >> 0x1f) - ((int)uVar10 >> 0x1f)) *
             (float10)_DAT_004a0a18 +
             (float10)_DAT_004a0a18 * extraout_ST0 * (float10)180.0 +
             ((float10)local_28 - (float10)local_20) * (float10)_DAT_004a0a18 * (float10)180.0 +
             (float10)dVar6 + (float10)dVar5 + (float10)dVar4;
    if (fVar13 == (float10)0.0) {
      return uVar12;
    }
    if (fVar13 < (float10)local_40) {
      local_40 = (double)fVar13;
      local_78 = uVar12;
    }
    uVar12 = uVar12 + 1;
    pbVar11 = pbVar11 + 3;
