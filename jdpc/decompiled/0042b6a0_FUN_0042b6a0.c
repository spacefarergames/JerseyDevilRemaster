...
bool __fastcall FUN_0042b6a0(undefined2 param_1)

{
  ...
  uVar1 = CONCAT22(param_1,(ushort)(in_NT & 1) * 0x4000 | (ushort)(in_OF & 1) * 0x800 |
                           (ushort)(in_IF & 1) * 0x200 | (ushort)(in_TF & 1) * 0x100 |
                           (ushort)(in_SF & 1) * 0x80 | (ushort)(in_ZF & 1) * 0x40 |
                           (ushort)(in_AF & 1) * 0x10 | (ushort)(in_PF & 1) * 4 |
                           (ushort)(in_CF & 1));
  uVar2 = uVar1 ^ 0x40000;
  local_8 = (undefined2)(uVar2 >> 0x10);
  return CONCAT22(local_8,(ushort)((uVar2 & 0x4000) != 0) * 0x4000 |
