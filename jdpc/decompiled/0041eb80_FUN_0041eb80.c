    ...
    do {
      ...
      for (puVar2 = puVar6; puVar2 != (undefined4 *)0x0; puVar2 = (undefined4 *)*puVar2) {
        ...
        if (0 < (int)DAT_0055ed60) {
          ...
          uVar3 = puVar2[6] << 0x10;
          pcVar8 = (char *)(DAT_0055e1c8 + ((int)puVar2[6] >> 0x10) +
          ...
          do {
            ...
            cVar1 = *pcVar8;
            pcVar8 = pcVar8 + (uint)bVar11 + *(int *)(&DAT_0055e1c4 + (uint)bVar10 * -4);
            bVar10 = CARRY4(uVar7,DAT_005618e8);
            uVar7 = uVar7 + DAT_005618e8;
            if (cVar1 != '\0') {
              *(undefined1 *)(iVar9 + iVar5) =
                   *(undefined1 *)
                    (DAT_00642504 + (uint)CONCAT11(cVar1,*(undefined1 *)(iVar9 + iVar5)));
            }
            iVar5 = iVar5 + 1;
          } while (iVar5 != 0);
        }
