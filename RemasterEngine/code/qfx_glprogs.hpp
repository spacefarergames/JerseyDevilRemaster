...
static const char g_szVertexShader_PlanarShadow[] =
"#version 120\n"
"void main(void)\n"
"{\n"
"gl_TexCoord[0] = gl_MultiTexCoord0;\n"
...
static const char g_szFragmentShader_PlanarShadow[] =
"#version 120\n"
"#extension GL_ARB_texture_rectangle : enable\n"
"uniform vec4 Local0;\n"
"uniform vec4 Local1;\n"
...
"float read_depth( vec2 coord )\n"
"{\n"
"return Local0.x / (Local0.y + Local0.x - texture2DRect( Texture1, coord ).r * Local0.y);\n"
"}\n"
"void main(void)\n"
"{\n"
"vec2 coord = gl_TexCoord[0].xy;\n"
"vec3 col = texture2DRect( Texture0, coord ).rgb;\n"
"float receiver = read_depth( coord );\n"
"float shadow = 0.0;\n"
"if ( receiver > Local1.z && receiver < Local1.w ) {\n"
"for ( int i = 1; i <= 6; ++i ) {\n"
"float t = float(i) / 6.0;\n"
"vec2 ofs = Local2.xy * t;\n"
"float caster = read_depth( coord - ofs );\n"
"float depthGap = receiver - caster;\n"
"float range = Local1.y * (0.35 + t);\n"
"float candidate = smoothstep( 0.001, range, depthGap ) * (1.0 - t * 0.72);\n"
"candidate *= 1.0 - smoothstep( range, range * 2.5, depthGap );\n"
"shadow = max( shadow, candidate );\n"
"}\n"
"shadow *= Local1.x;\n"
"shadow = clamp( shadow, 0.0, 0.65 );\n"
"}\n"
"gl_FragColor.rgb = col * (1.0 - shadow);\n"
"gl_FragColor.a = 1.0;\n"
"}\n";
