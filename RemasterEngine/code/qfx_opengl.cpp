...
void WINAPI glBindTexture( GLenum target, GLuint texture ) { gl::qglBindTexture( target, texture ); QFXRenderer::Instance().SetupTextureAccuracy( target ); }
...
void WINAPI glHint( GLenum target, GLenum mode ) { gl::qglHint( target, QFXRenderer::Instance().SetupPerspectiveHint( target, mode ) ); }
...
void WINAPI glScissor( GLint x, GLint y, GLsizei width, GLsizei height ) { QFXRenderer::Instance().SetupHudViewport( x, y, width, height, false ); gl::qglScissor( x, y, width, height ); }
...
void WINAPI glTexParameterfv( GLenum target, GLenum pname, const GLfloat *params ) { GLfloat fixedParam = params ? QFXRenderer::Instance().SetupTextureParameter( target, pname, *params ) : 0.0f; gl::qglTexParameterfv( target, pname, ( params && ( pname == GL_TEXTURE_LOD_BIAS || pname == GL_TEXTURE_MAG_FILTER ) ) ? &fixedParam : params ); }
void WINAPI glTexParameteriv( GLenum target, GLenum pname, const GLint *params ) { GLint fixedParam = params ? QFXRenderer::Instance().SetupTextureParameter( target, pname, *params ) : 0; gl::qglTexParameteriv( target, pname, ( params && ( pname == GL_TEXTURE_LOD_BIAS || pname == GL_TEXTURE_MAG_FILTER ) ) ? &fixedParam : params ); }
...
void WINAPI glTranslated( GLdouble x, GLdouble y, GLdouble z ) { gl::qglTranslated( QFXRenderer::Instance().SetupHudTranslateX( x ), y, z ); }
void WINAPI glTranslatef( GLfloat x, GLfloat y, GLfloat z ) { gl::qglTranslatef( static_cast<GLfloat>( QFXRenderer::Instance().SetupHudTranslateX( x ) ), y, z ); }
void WINAPI glVertex2d( GLdouble x, GLdouble y ) { gl::qglVertex2d( QFXRenderer::Instance().SetupHudVertexX( x ), y ); }
void WINAPI glVertex2dv( const GLdouble *v ) { GLdouble fixed[2] = { QFXRenderer::Instance().SetupHudVertexX( v[0] ), v[1] }; gl::qglVertex2dv( fixed ); }
void WINAPI glVertex2f( GLfloat x, GLfloat y ) { gl::qglVertex2f( static_cast<GLfloat>( QFXRenderer::Instance().SetupHudVertexX( x ) ), y ); }
void WINAPI glVertex2fv( const GLfloat *v ) { GLfloat fixed[2] = { static_cast<GLfloat>( QFXRenderer::Instance().SetupHudVertexX( v[0] ) ), v[1] }; gl::qglVertex2fv( fixed ); }
void WINAPI glVertex2i( GLint x, GLint y ) { gl::qglVertex2i( static_cast<GLint>( QFXRenderer::Instance().SetupHudVertexX( x ) ), y ); }
void WINAPI glVertex2iv( const GLint *v ) { GLint fixed[2] = { static_cast<GLint>( QFXRenderer::Instance().SetupHudVertexX( v[0] ) ), v[1] }; gl::qglVertex2iv( fixed ); }
void WINAPI glVertex2s( GLshort x, GLshort y ) { gl::qglVertex2s( static_cast<GLshort>( QFXRenderer::Instance().SetupHudVertexX( x ) ), y ); }
void WINAPI glVertex2sv( const GLshort *v ) { GLshort fixed[2] = { static_cast<GLshort>( QFXRenderer::Instance().SetupHudVertexX( v[0] ) ), v[1] }; gl::qglVertex2sv( fixed ); }
void WINAPI glVertex3d( GLdouble x, GLdouble y, GLdouble z ) { gl::qglVertex3d( QFXRenderer::Instance().SetupHudVertexX( x ), y, z ); }
void WINAPI glVertex3dv( const GLdouble *v ) { GLdouble fixed[3] = { QFXRenderer::Instance().SetupHudVertexX( v[0] ), v[1], v[2] }; gl::qglVertex3dv( fixed ); }
void WINAPI glVertex3f( GLfloat x, GLfloat y, GLfloat z ) { gl::qglVertex3f( static_cast<GLfloat>( QFXRenderer::Instance().SetupHudVertexX( x ) ), y, z ); }
void WINAPI glVertex3fv( const GLfloat *v ) { GLfloat fixed[3] = { static_cast<GLfloat>( QFXRenderer::Instance().SetupHudVertexX( v[0] ) ), v[1], v[2] }; gl::qglVertex3fv( fixed ); }
void WINAPI glVertex3i( GLint x, GLint y, GLint z ) { gl::qglVertex3i( static_cast<GLint>( QFXRenderer::Instance().SetupHudVertexX( x ) ), y, z ); }
void WINAPI glVertex3iv( const GLint *v ) { GLint fixed[3] = { static_cast<GLint>( QFXRenderer::Instance().SetupHudVertexX( v[0] ) ), v[1], v[2] }; gl::qglVertex3iv( fixed ); }
void WINAPI glVertex3s( GLshort x, GLshort y, GLshort z ) { gl::qglVertex3s( static_cast<GLshort>( QFXRenderer::Instance().SetupHudVertexX( x ) ), y, z ); }
void WINAPI glVertex3sv( const GLshort *v ) { GLshort fixed[3] = { static_cast<GLshort>( QFXRenderer::Instance().SetupHudVertexX( v[0] ) ), v[1], v[2] }; gl::qglVertex3sv( fixed ); }
void WINAPI glVertex4d( GLdouble x, GLdouble y, GLdouble z, GLdouble w ) { gl::qglVertex4d( QFXRenderer::Instance().SetupHudVertexX( x ), y, z, w ); }
void WINAPI glVertex4dv( const GLdouble *v ) { GLdouble fixed[4] = { QFXRenderer::Instance().SetupHudVertexX( v[0] ), v[1], v[2], v[3] }; gl::qglVertex4dv( fixed ); }
void WINAPI glVertex4f( GLfloat x, GLfloat y, GLfloat z, GLfloat w ) { gl::qglVertex4f( static_cast<GLfloat>( QFXRenderer::Instance().SetupHudVertexX( x ) ), y, z, w ); }
void WINAPI glVertex4fv( const GLfloat *v ) { GLfloat fixed[4] = { static_cast<GLfloat>( QFXRenderer::Instance().SetupHudVertexX( v[0] ) ), v[1], v[2], v[3] }; gl::qglVertex4fv( fixed ); }
void WINAPI glVertex4i( GLint x, GLint y, GLint z, GLint w ) { gl::qglVertex4i( static_cast<GLint>( QFXRenderer::Instance().SetupHudVertexX( x ) ), y, z, w ); }
void WINAPI glVertex4iv( const GLint *v ) { GLint fixed[4] = { static_cast<GLint>( QFXRenderer::Instance().SetupHudVertexX( v[0] ) ), v[1], v[2], v[3] }; gl::qglVertex4iv( fixed ); }
void WINAPI glVertex4s( GLshort x, GLshort y, GLshort z, GLshort w ) { gl::qglVertex4s( static_cast<GLshort>( QFXRenderer::Instance().SetupHudVertexX( x ) ), y, z, w ); }
void WINAPI glVertex4sv( const GLshort *v ) { GLshort fixed[4] = { static_cast<GLshort>( QFXRenderer::Instance().SetupHudVertexX( v[0] ) ), v[1], v[2], v[3] }; gl::qglVertex4sv( fixed ); }
...
void WINAPI glViewport( GLint x, GLint y, GLsizei width, GLsizei height ) { QFXRenderer::Instance().SetupHudViewport( x, y, width, height, false ); gl::qglViewport( x, y, width, height ); }
